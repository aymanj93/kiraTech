<template>
    <div class="bg-white sticky top-0 z-2">
        <div class="flex justify-between items-center px-10 md:px-0 md:w-3/4 py-7 mx-auto">
            <img alt="Vue logo" class="logo" src="@/assets/logo.png" width="381" height="510" />
